...
Análise **estática** anti-stub / mock / TODO para uma task. Complementa [DEC-032](../DECISION-LOG.md). Camada semântica via agente IDE + `--from-agent`.
...
| Item | Classificação |
|------|---------------|
| Enrichment `--ai` soft stub (sem LLM nativo) | **B** (DEC-032) |
