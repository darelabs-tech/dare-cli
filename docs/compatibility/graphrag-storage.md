...
Library-first crate `dare-graph`: trait `KnowledgeGraph`, backends SQLite + JSON, IDs canônicos, BLOB f32 LE, migrations explícitas. Complementa [ADR-006](../adr/ADR-006-compatibilidade-migracao-graph-db.md) e [DEC-036](../DECISION-LOG.md).
