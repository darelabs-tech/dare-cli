...
**Objetivo:** Extrair convencoes, tooling, arquitetura, testes e historico Git.

**Posicao na sequencia:** 37 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **dna**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.
...
- [ ] Coletar fatos de manifests e configs
- [ ] Analisar naming e arquitetura
- [ ] Analisar testes e bibliotecas
- [ ] Ler git log de forma limitada
- [ ] Gerar PROJECT-DNA.md
- [ ] Implementar --check e --ast
- [ ] Criar capability dare-dna
- [ ] Indexar fatos no grafo quando disponivel
...
- `crates/dare-cli/src/commands/dna.rs`
...
- [ ] Implementar e revisar: Coletar fatos de manifests e configs.
- [ ] Implementar e revisar: Analisar naming e arquitetura.
- [ ] Implementar e revisar: Analisar testes e bibliotecas.
- [ ] Implementar e revisar: Ler git log de forma limitada.
- [ ] Implementar e revisar: Gerar PROJECT-DNA.md.
- [ ] Implementar e revisar: Implementar --check e --ast.
- [ ] Implementar e revisar: Criar capability dare-dna.
- [ ] Implementar e revisar: Indexar fatos no grafo quando disponivel.
...
- [ ] Fatos possuem evidencia de origem.
- [ ] Check nao escreve.
- [ ] Projetos sem Git continuam funcionando.
...
Quando todos os criterios acima estiverem concluidos, avance para [`038-patterns.md`](038-patterns.md).
