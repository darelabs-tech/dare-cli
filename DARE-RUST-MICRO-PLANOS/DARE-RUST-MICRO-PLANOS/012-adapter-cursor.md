...
**Objetivo:** Implementar deteccao, instalacao e validacao dos artefatos Cursor.

**Posicao na sequencia:** 12 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **adapter cursor**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.
...
- [ ] Detectar .cursor e .cursorrules
- [ ] Gerar .cursorrules
- [ ] Instalar commands .md
- [ ] Instalar rules .mdc
- [ ] Validar frontmatter
- [ ] Gerar rules condicionais de stack
- [ ] Preservar customizacoes
...
- [ ] Implementar e revisar: Detectar .cursor e .cursorrules.
- [ ] Implementar e revisar: Gerar .cursorrules.
- [ ] Implementar e revisar: Instalar commands .md.
- [ ] Implementar e revisar: Instalar rules .mdc.
- [ ] Implementar e revisar: Validar frontmatter.
- [ ] Implementar e revisar: Gerar rules condicionais de stack.
- [ ] Implementar e revisar: Preservar customizacoes.
...
- [ ] 33 commands e 25 rules cobertos ou excecoes registradas.
- [ ] Frontmatter valido.
...
- Implementacao revisada de **Adapter Cursor**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`013-adapter-codex.md`](013-adapter-codex.md).
