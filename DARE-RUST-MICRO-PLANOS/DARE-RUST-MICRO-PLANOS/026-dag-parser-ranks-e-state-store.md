# 026 — DAG: parser, ranks e state store

**Objetivo:** Implementar o nucleo do DAG Runner antes da execucao de agentes.

**Posicao na sequencia:** 26 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **dag: parser, ranks e state store**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 005, 007 e 020 concluidos

## Escopo incluido

- [ ] Implementar rank longest-path
- [ ] Detectar ciclos
- [ ] Implementar cascading skip
- [ ] Criar state store v1
- [ ] Adicionar file lock
- [ ] Criar transicoes atomicas
- [ ] Implementar canvas base
...
- `crates/dare-dag/src/graph.rs`
- `crates/dare-dag/src/state.rs`
- `crates/dare-dag/src/canvas.rs`
...
- [ ] Implementar e revisar: Implementar rank longest-path.
- [ ] Implementar e revisar: Detectar ciclos.
- [ ] Implementar e revisar: Implementar cascading skip.
- [ ] Implementar e revisar: Criar state store v1.
- [ ] Implementar e revisar: Adicionar file lock.
- [ ] Implementar e revisar: Criar transicoes atomicas.
- [ ] Implementar e revisar: Implementar canvas base.
- [ ] Implementar e revisar: Adicionar property tests.
...
- [ ] Ranks equivalem a baseline.
- [ ] Crash nao corrompe state.
- [ ] Concorrencia falha claramente ou serializa.
...
- Implementacao revisada de **DAG: parser, ranks e state store**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`027-dag-visualizacao.md`](027-dag-visualizacao.md).
