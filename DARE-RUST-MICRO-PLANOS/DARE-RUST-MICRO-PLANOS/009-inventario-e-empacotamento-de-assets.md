# 009 — Inventario e empacotamento de assets

**Objetivo:** Transformar templates, rules, commands e skills atuais em assets rastreaveis.

**Posicao na sequencia:** 9 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **inventario e empacotamento de assets**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 001 e 002 concluidos

## Escopo incluido

- [ ] Inventariar todos os assets TypeScript
- [ ] Calcular hashes da baseline
- [ ] Classificar assets canonicos e gerados
- [ ] Definir diretorio assets/
- [ ] Eliminar fontes duplicadas editaveis
- [ ] Criar manifest de assets
- [ ] Incorporar assets com include_dir ou rust-embed
- [ ] Criar comando interno de verificacao
...
- [ ] Implementar e revisar: Inventariar todos os assets TypeScript.
- [ ] Implementar e revisar: Calcular hashes da baseline.
- [ ] Implementar e revisar: Classificar assets canonicos e gerados.
- [ ] Implementar e revisar: Definir diretorio assets/.
- [ ] Implementar e revisar: Eliminar fontes duplicadas editaveis.
- [ ] Implementar e revisar: Criar manifest de assets.
- [ ] Implementar e revisar: Incorporar assets com include_dir ou rust-embed.
- [ ] Implementar e revisar: Criar comando interno de verificacao.
...
- [ ] Nenhum asset da baseline fica sem classificacao.
- [ ] Build falha em hash ou arquivo ausente.
- [ ] Assets podem ser materializados sem Node.
...
- Implementacao revisada de **Inventario e empacotamento de assets**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`010-modelo-canonico-de-capabilities.md`](010-modelo-canonico-de-capabilities.md).
