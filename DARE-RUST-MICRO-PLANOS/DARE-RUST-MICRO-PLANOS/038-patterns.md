...
**Objetivo:** Minerar padroes por frequencia e coocorrencia.

**Posicao na sequencia:** 38 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **patterns**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 035 e 037 concluidos

## Escopo incluido

- [ ] Implementar kinds de padrao
- [ ] Calcular frequencia/coocorrencia
- [ ] Gerar PATTERNS.md
- [ ] Implementar --modules e --inject
- [ ] Usar AST opcional
- [ ] Adicionar --check
- [ ] Criar capability dare-patterns
- [ ] Indexar padroes no grafo quando disponivel
...
- `crates/dare-cli/src/commands/patterns.rs`
...
- [ ] Implementar e revisar: Implementar kinds de padrao.
- [ ] Implementar e revisar: Calcular frequencia/coocorrencia.
- [ ] Implementar e revisar: Gerar PATTERNS.md.
- [ ] Implementar e revisar: Implementar --modules e --inject.
- [ ] Implementar e revisar: Usar AST opcional.
- [ ] Implementar e revisar: Adicionar --check.
- [ ] Implementar e revisar: Criar capability dare-patterns.
- [ ] Implementar e revisar: Indexar padroes no grafo quando disponivel.
...
- [ ] Resultados sao explicaveis.
- [ ] Inject preserva conteudo existente.
- [ ] Ordenacao e scores sao estaveis.
...
- Implementacao revisada de **Patterns**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`039-migrate.md`](039-migrate.md).
