...
**Objetivo:** Entregar diagnostico read-only da instalacao e do projeto.

**Posicao na sequencia:** 17 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **comando info**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 007 a 015 concluidos

## Escopo incluido

- [ ] Exibir versao e plataforma
- [ ] Detectar project root
- [ ] Listar integridade de assets
- [ ] Exibir backend e path do grafo
- [ ] Exibir progresso de tasks
- [ ] Adicionar --json estavel
- [ ] Garantir zero mutacoes
...
- `crates/dare-cli/src/commands/info.rs`
...
- [ ] Implementar e revisar: Exibir versao e plataforma.
- [ ] Implementar e revisar: Detectar project root.
- [ ] Implementar e revisar: Listar integridade de assets.
- [ ] Implementar e revisar: Exibir backend e path do grafo.
- [ ] Implementar e revisar: Exibir progresso de tasks.
- [ ] Implementar e revisar: Adicionar --json estavel.
- [ ] Implementar e revisar: Garantir zero mutacoes.
...
- [ ] Comando e estritamente read-only.
- [ ] JSON e versionavel.
- [ ] Projeto sem DARE recebe diagnostico util.
...
- Implementacao revisada de **Comando info**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`018-discover-deteccao-brownfield.md`](018-discover-deteccao-brownfield.md).
