# 040 — GraphRAG: storage e compatibilidade

**Objetivo:** Portar schema, IDs e backends SQLite/JSON antes da busca.

**Posicao na sequencia:** 40 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **graphrag: storage e compatibilidade**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 005, 007 e 026 concluidos

## Escopo incluido

- [ ] Implementar KnowledgeGraph trait
- [ ] Criar backend rusqlite bundled
- [ ] Manter schema de nodes/edges
- [ ] Preservar BLOB f32 little-endian
- [ ] Implementar backend JSON
- [ ] Criar IDs canonicos
- [ ] Testar banco legado
- [ ] Adicionar migrations explicitamente versionadas
...
- [ ] Implementar e revisar: Implementar KnowledgeGraph trait.
- [ ] Implementar e revisar: Criar backend rusqlite bundled.
- [ ] Implementar e revisar: Manter schema de nodes/edges.
- [ ] Implementar e revisar: Preservar BLOB f32 little-endian.
- [ ] Implementar e revisar: Implementar backend JSON.
- [ ] Implementar e revisar: Criar IDs canonicos.
- [ ] Implementar e revisar: Testar banco legado.
- [ ] Implementar e revisar: Adicionar migrations explicitamente versionadas.
...
- [ ] Rust abre e muta copia do DB legado.
- [ ] IDs permanecem identicos.
...
- Implementacao revisada de **GraphRAG: storage e compatibilidade**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`041-graphrag-ingest-keyword-bfs-e-rrf.md`](041-graphrag-ingest-keyword-bfs-e-rrf.md).
