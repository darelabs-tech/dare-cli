...
**Objetivo:** Gerar plano de migracao e cenarios de paridade para uma stack alvo.

**Posicao na sequencia:** 39 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **migrate**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 024, 36, 37 e 38 concluidos

## Escopo incluido

- [ ] Validar stack alvo
- [ ] Comparar stack atual e alvo
- [ ] Gerar plano por fases
- [ ] Gerar Gherkin de paridade
- [ ] Implementar --check
- [ ] Adicionar enrichment
- [ ] Criar capability dare-migrate
- [ ] Nao executar migracao destrutiva
...
- `crates/dare-project/src/migrate.rs`
- `crates/dare-cli/src/commands/migrate.rs`
- `assets/capabilities/dare-migrate`
...
- [ ] Implementar e revisar: Validar stack alvo.
- [ ] Implementar e revisar: Comparar stack atual e alvo.
- [ ] Implementar e revisar: Gerar plano por fases.
- [ ] Implementar e revisar: Gerar Gherkin de paridade.
- [ ] Implementar e revisar: Implementar --check.
- [ ] Implementar e revisar: Adicionar enrichment.
- [ ] Implementar e revisar: Criar capability dare-migrate.
- [ ] Implementar e revisar: Nao executar migracao destrutiva.
...
- [ ] Stack invalida falha cedo.
- [ ] Plano referencia evidencias do projeto.
- [ ] Check nao escreve.
...
- Implementacao revisada de **Migrate**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`040-graphrag-storage-e-compatibilidade.md`](040-graphrag-storage-e-compatibilidade.md).
