# 024 — Fundacao de enrichment por IA

**Objetivo:** Criar o pipeline opcional de providers, schemas e injecao validada.

**Posicao na sequencia:** 24 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **fundacao de enrichment por ia**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 006 e 023 concluidos

## Escopo incluido

- [ ] Definir AiProvider
- [ ] Implementar mock
- [ ] Implementar um provider CLI real
- [ ] Adicionar overrides DARE_*_COMMAND
- [ ] Aplicar timeout de 20 minutos
- [ ] Validar respostas por schema
- [ ] Injetar somente em markers gerenciados
- [ ] Redigir logs
...
- [ ] Implementar e revisar: Definir AiProvider.
- [ ] Implementar e revisar: Implementar mock.
- [ ] Implementar e revisar: Implementar um provider CLI real.
- [ ] Implementar e revisar: Adicionar overrides DARE_*_COMMAND.
- [ ] Implementar e revisar: Aplicar timeout de 20 minutos.
- [ ] Implementar e revisar: Validar respostas por schema.
- [ ] Implementar e revisar: Injetar somente em markers gerenciados.
- [ ] Implementar e revisar: Redigir logs.
...
- [ ] Falha de provider nao corrompe documento.
- [ ] Mock permite testes deterministas.
- [ ] Retorno invalido e rejeitado.
...
- Implementacao revisada de **Fundacao de enrichment por IA**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`025-blueprint.md`](025-blueprint.md).
