# 044 — Skills registry: modelo e resolucao

**Objetivo:** Portar manifest, registries e dependencias das skills-pacote.

**Posicao na sequencia:** 44 de 56

## Resultado esperado

Ao concluir este microplano, o projeto tera uma entrega verificavel relacionada a **skills registry: modelo e resolucao**, sem depender de etapas futuras para demonstrar o comportamento principal definido neste escopo.

## Pre-requisitos

- [ ] Microplanos 005, 007 e 009 concluidos

## Escopo incluido

- [ ] Definir RegistrySkill e SkillManifest
- [ ] Ler .dare/skills.yml legado
- [ ] Implementar registry mock
- [ ] Implementar registry local
- [ ] Implementar registry remoto com timeout
- [ ] Resolver dependencias topologicamente
- [ ] Distinguir seis skills genericas e skill de stack
- [ ] Adicionar lockfile opcional por ADR
...
- `crates/dare-skills/src/model.rs`
- `crates/dare-skills/src/registry.rs`
...
- [ ] Implementar e revisar: Definir RegistrySkill e SkillManifest.
- [ ] Implementar e revisar: Ler .dare/skills.yml legado.
- [ ] Implementar e revisar: Implementar registry mock.
- [ ] Implementar e revisar: Implementar registry local.
- [ ] Implementar e revisar: Implementar registry remoto com timeout.
- [ ] Implementar e revisar: Resolver dependencias topologicamente.
- [ ] Implementar e revisar: Distinguir seis skills genericas e skill de stack.
- [ ] Implementar e revisar: Adicionar lockfile opcional por ADR.
...
- [ ] List/info respeitam prioridade remote>local>mock.
- [ ] Ciclos de dependencia sao detectados.
- [ ] Fallback remoto nao derruba o comando.
...
- Implementacao revisada de **Skills registry: modelo e resolucao**.
...
Quando todos os criterios acima estiverem concluidos, avance para [`045-skills-lifecycle-e-publish-seguro.md`](045-skills-lifecycle-e-publish-seguro.md).
