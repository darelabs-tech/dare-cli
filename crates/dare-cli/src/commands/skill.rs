//! `dare skill list|info` (microplano 044).

use std::process::ExitCode;

use dare_core::{CoreError, CoreResult, ProjectRoot};
use dare_skills::{load_project_skills, CompositeRegistry, RegistrySkill, SkillKind};
...
fn run_skill_inner(action: SkillAction) -> CoreResult<(String, Value)> {
    ...
    // Prefer project root when cwd is a directory; registries do not require a DARE project.
